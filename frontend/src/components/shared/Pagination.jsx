...
const Pagination = ({
  ...
  return (
    <div
      className={`sticky bottom-0 z-20 mt-0 flex min-h-[58px] flex-col gap-3 border-t border-[#2e66a6] bg-[#FFFFFF] px-4 py-3 lg:flex-row lg:items-center lg:justify-between ${className}`}
      aria-label={ariaLabel}
    >
      <div className="whitespace-nowrap text-xs font-medium text-[#000000]">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
        <label className="flex items-center gap-2 text-sm font-medium text-[#000000]">
          <span className="whitespace-nowrap text-xs text-[#000000]">Display Per Page:</span>
          <select
            value={pageSize}
            onChange={handlePageSizeChange}
            className="h-9 min-w-[74px] rounded-lg border border-[#2e66a6] bg-[#FFFFFF] px-3 text-xs text-[#000000] outline-none focus:border-[#2e66a6] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2e66a6]/30"
          >
        ...
        <nav
          className="inline-flex min-h-9 items-center bg-[#FFFFFF]"
          aria-label={ariaLabel}
        >
          <button
            type="button"
            ...
            disabled={safePage === 1}
            className="inline-flex h-9 items-center gap-1 px-2 text-xs font-semibold text-[#000000] transition hover:text-[#2e66a6] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2e66a6]/30 disabled:cursor-not-allowed disabled:opacity-40"
          >
           <svg
          ...
          <div className="flex h-9 items-center gap-1 px-1">
            {paginationItems.map((item) =>
              typeof item === 'string' ? (
                <span
                  key={item}
                  className="inline-flex h-8 min-w-8 select-none items-center justify-center px-1 text-xs font-bold text-[#000000]"
                  aria-hidden="true"
                >
                  ...
                </span>
                ...
                <button
                  ...
                  className={`h-8 min-w-8 rounded-lg px-2 text-xs font-semibold transition focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2e66a6]/30 focus-visible:ring-offset-1 ${
                    safePage === item
                      ? 'bg-[#2e66a6] text-[#FFFFFF] shadow-sm'
                      : 'bg-[#FFFFFF] text-[#000000] hover:bg-[#2e66a6] hover:text-[#FFFFFF]'
                  }`}
                >
                  {item}
                </button>
