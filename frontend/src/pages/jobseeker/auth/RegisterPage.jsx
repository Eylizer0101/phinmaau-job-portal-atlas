                      ...
                      {[
                        ...
                        return (
                          <button
                            ...
                            onClick={() => {
                              if (loading) return;
                              setFormData((prev) => ({ ...prev, preferredWorkMode: value }));
                              clearError('preferredWorkMode');
                              setServerError('');
                            }}
                            disabled={loading}
                            className={`min-h-[76px] rounded-xl border px-3 py-3 text-center transition ${
                              selected
                                ? 'border-[#2e66a6] bg-blue-50 text-[#2e66a6] ring-1 ring-[#2e66a6]'
                                : 'border-gray-200 bg-white text-gray-700 hover:border-[#2e66a6]/50 hover:bg-blue-50/30'
                            } disabled:opacity-50`}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="w-full">
                  ...
                  <ul className="mt-2 text-sm text-gray-700 list-disc pl-5 space-y-1">
                    ...
                    <li><strong>Diploma &amp; TOR:</strong> Upload a clear scan or well-lit photo of the complete document. If your Diploma or TOR is not yet available, you may upload proof of request or a claim document from the Registrar’s Office.</li>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-[#2e66a6]/10 flex items-center justify-center p-2 sm:p-4">
      ...
      <div className="w-full max-w-[1340px] relative">
        <button
          ...
          className="absolute left-0 top-2 z-50 w-9 h-9 flex items-center justify-center rounded-full border border-gray-200 bg-white hover:bg-gray-50 transition focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#2e66a6]/20"
          aria-label="Go back"
          title="Go back"
        >
