  ...
  />
          ...
          <section className="rounded-[18px] border border-[#d1d5db] bg-white p-5 shadow-[0_2px_6px_rgba(15,23,42,0.05)] sm:p-7">
            <div className="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_340px_360px] lg:items-center">
              <div>
                <h1 className="text-xl font-bold text-black sm:text-[22px] xl:whitespace-nowrap">All Applications Reviews at {companyName}</h1>
                <p className="mt-1 text-black/65">{reviews.length} Total Application{reviews.length === 1 ? '' : 's'}</p>
              </div>
