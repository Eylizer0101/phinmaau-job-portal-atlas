    ...
    <EmployerLayout>
      <main className="min-h-screen px-1 py-8">
        <div className="mx-auto w-full max-w-7xl">
          <button type="button" onClick={() => navigate('/employer/company-profile', { state: { activeTab: 'jobs' } })} className="mb-5 inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50">
