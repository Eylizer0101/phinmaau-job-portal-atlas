    ...
    <EmployerLayout>
      <div className="mx-auto max-w-7xl px-1 py-8">
          ...
          <div className="flex min-h-0 flex-col p-6">
            {loading ? (
              ...
              <>
                ...
                {totalItems >= 10 ? (
                  <Pagination currentPage={currentPage} totalItems={totalItems} pageSize={pageSize} onPageChange={setCurrentPage} onPageSizeChange={setPageSize} ariaLabel="Archived declined applicants pagination" className="!min-h-[50px] !py-2" />
                ) : null}
              </>
            )}
          </div>
        ...
        <Modal
          ...
          applicantName={restoreTarget ? buildApplicantName(restoreTarget.jobseeker) : ''}
          confirmText="Restore"
          cancelText="Cancel"
