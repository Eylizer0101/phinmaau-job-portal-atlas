...
const MIN_COMPANY_DESCRIPTION_LENGTH = 100;
const MAX_COMPANY_DESCRIPTION_LENGTH = 1000;
const MAX_OFFICE_ADDRESS_LENGTH = 100;
...
>
  ...
  />
                          ...
                          {companyReviews.slice(0, 6).map((review, index) => (
                            <article key={review._id || index} className="rounded-2xl border border-[#dfe7f0] bg-white px-5 py-5 shadow-[0_10px_28px_rgba(46,102,166,0.06)] sm:px-6 sm:py-6">
                              <div className="flex flex-wrap items-start justify-between gap-3">
                                ...
                                <span className="rounded-full border border-[#dfe7f0] bg-transparent px-3 py-1 text-xs font-semibold text-black/60">{getReviewOutcome(review.outcome)}</span>
                              </div>
        ...
        {isEditOpen && (
          <div className="fixed inset-y-0 right-0 left-0 z-[70]  md:left-[18rem]">
