            ...
            <div className="min-w-0 flex-1 pr-1">
              ...
              >
                <p>
                  ...
                  that <span className="font-bold text-black">{companyName}</span>{" "}
                  has been reviewed and verified for all PHINMA AU requirements.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-[#D8E0EA] bg-white px-6 py-4 sm:px-7">
            <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
              <Button
                variant="secondary"
                size="lg"
                className="w-full sm:w-auto min-w-[145px] !h-11 rounded-lg border-[#D6DEE8] bg-white text-sm font-semibold"
                onClick={onClose}
                disabled={loading}
              >
                Cancel
              ...
              <Button
                variant="primary"
                size="lg"
                className="w-full sm:w-auto min-w-[185px] !h-11 rounded-lg text-sm font-semibold !bg-[#2e66a6] hover:!bg-[#255587]"
                onClick={onConfirm}
                loading={loading}
                disabled={disabled || loading}
              >
...
const EmployerVerificationDetails = () => {
  ...
  if (loading) {
    return (
      <AdminLayout>
        <div className="min-h-[calc(100vh-8rem)]" aria-hidden="true" />
      </AdminLayout>
    );
  }
          ...
          <div className="relative w-full max-w-[470px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl" role="dialog" aria-modal="true" aria-labelledby="approve-employer-credential-title">
            <div className="flex items-start gap-4 px-6 pb-5 pt-6">
              ...
              <div className="min-w-0 flex-1 pr-7">
                <h3 id="approve-employer-credential-title" className="text-lg font-bold leading-6 text-black">
            ...
            <div className="flex justify-end gap-2 border-t border-slate-100 bg-slate-50 px-6 py-4">
              ...
              <button type="button" onClick={() => approveDocument(verifyCredential.key)} disabled={Boolean(action)} className={cn("inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-[#2e66a6] px-5 text-sm font-bold text-white shadow-sm hover:bg-[#255587] disabled:opacity-50", UI.ring)}>
                <SvgIcon name="check" className="h-4 w-4" />
