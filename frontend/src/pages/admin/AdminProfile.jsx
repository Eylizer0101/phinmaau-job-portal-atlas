      ...
      <div className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm sm:p-9">
          ...
          <form onSubmit={updatePassword} className="mt-5 space-y-4">
            ...
            <button disabled={updatingPassword} className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-[#173b78] text-sm font-bold text-white transition hover:bg-[#102d5e] disabled:opacity-60"><LockKeyhole size={16} />{updatingPassword ? "Updating..." : "Update Password"}</button>
          </form>
        </section>
      </div>
