          ...
          {error ? (
            ...
            <>
              <section className="rounded-2xl border border-[#dfe5ec] bg-white p-5 shadow-sm">
                <div className={`grid gap-3 ${hasActiveFilters ? "lg:grid-cols-[minmax(0,1.7fr)_minmax(170px,1fr)_minmax(150px,0.9fr)_minmax(180px,1fr)_auto]" : "lg:grid-cols-[minmax(0,1.7fr)_minmax(170px,1fr)_minmax(150px,0.9fr)_minmax(180px,1fr)]"}`}>
                  ...
                  <table className="min-w-[920px] w-full table-fixed text-left text-[15px]">
                    ...
                    <thead className="border-y border-[#e5e7eb] text-xs font-semibold uppercase tracking-wide text-black/60 sticky top-0 z-10 bg-[#f7f9fc] shadow-[0_1px_0_rgba(226,232,240,1)]">
                      <tr>
                        ...
                        <th className="px-3 py-4 text-center">Vacancy</th>
                      ...
                      {loading && paginatedJobs.length === 0 ? (
                        ...
                        paginatedJobs.map((job) => {
                          ...
                          return (
                            ...
                            >
                              <td className="whitespace-nowrap px-4 py-6 text-[15px] font-normal text-black/70">
                              ...
                              <td className="px-3 py-6 text-center text-[16px] font-medium text-black">
                              ...
                              <td className="px-3 py-6 text-left">
                                <button
                                  ...
                                  className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-[#dfe5ec] bg-white text-black transition hover:border-[#2e66a6]/40 hover:bg-[#f7faff] hover:text-[#2e66a6] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2e66a6]"
                                  title="View job"
                                  aria-label={`View ${
                                    job?.title ||
                                    job?.jobTitle ||
