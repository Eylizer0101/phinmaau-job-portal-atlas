...
router.get('/analytics', require('../controllers/analyticsController').getAnalytics);
router.post('/analytics/export-log', require('../controllers/analyticsController').logExport);
